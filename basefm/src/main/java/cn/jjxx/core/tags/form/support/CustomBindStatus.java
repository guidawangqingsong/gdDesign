package cn.jjxx.core.tags.form.support;
...
public class CustomBindStatus extends BindStatus {
	...
	public CustomBindStatus(PageContext pageContext, RequestContext requestContext, String path, boolean htmlEscape,
			Boolean nested, String valueWay, Object defaultValue) {
		...
		public CustomBindStatus(PageContext pageContext, RequestContext requestContext, String path, boolean htmlEscape,
			Boolean nested, String valueWay, Object defaultValue,Object showValue) {
		super(requestContext, path, htmlEscape);
		// 这是需要考虑问题
		this.htmlEscape = htmlEscape;
		this.nested = nested;
	...
	public static BindStatus create(PageContext pageContext, String pathToUse, RequestContext requestContext,
			Boolean htmlEscape, Boolean nested, String valueWay, Object defaultValue) {
		// 预处理防止报错
		if (!nested) {
	...
	public static BindStatus createMulit(PageContext pageContext, String pathToUse, RequestContext requestContext,
			Boolean htmlEscape, Boolean nested, String valueWay, Object defaultValue, Object showValue) {
		// 预处理防止报错
		if (!nested) {
			Map<String, Object> model = requestContext.getModel();
			if (model != null) {
		...
		return new CustomBindStatus(pageContext, requestContext, pathToUse, htmlEscape, nested, valueWay, defaultValue,showValue);
	}
