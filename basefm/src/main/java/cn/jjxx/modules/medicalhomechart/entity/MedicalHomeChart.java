package cn.jjxx.modules.medicalhomechart.entity;
 ...
 *
 */
@TableName("medical_home_chart")
@SuppressWarnings("serial")
public class MedicalHomeChart extends AbstractEntity<String> {
    ...
    /**预测次数*/
    @TableField(value = "predict_count")
