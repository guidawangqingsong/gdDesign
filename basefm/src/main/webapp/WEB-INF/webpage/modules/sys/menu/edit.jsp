		   ...
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td class="width-35" >
		             ...
		             <span class="help-block m-b-none"><i class="fa fa-info-circle"></i>控制器中定义的权限标识，<br /></span>
		             <label class="Validform_checktip"></label>
		         </td>
		      </tr>
		      <tr>
		         ...
		         <td class="width-35" >
		             <form:radiobuttons path="isshow"
								 dict="sf" defaultvalue="0"
								 htmlEscape="false"
								cssClass="i-checks required" />
		              <label class="Validform_checktip"></label>
		         </td>
		          <td  class="width-15 active text-right">	
		              <label><font color="red">*</font>是否为功能:</label>
		         </td>
		         <td class="width-35" >
		             <form:radiobuttons path="isfunc"
								 dict="sf" defaultvalue="0"
								 htmlEscape="false"
								cssClass="i-checks required" />
		              <label class="Validform_checktip"></label>
