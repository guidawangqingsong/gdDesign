...
<grid:grid id="menuGridId" async="true" treeGrid="true" gridSetting="{loadComplete:onloadFun}" expandColumn="name"  sortname="sort" url="${adminPath}/sys/menu/ajaxTreeList">
    ...
    <grid:column label="sys.menu.isfunc"  name="isfunc" dict="sf"/>
