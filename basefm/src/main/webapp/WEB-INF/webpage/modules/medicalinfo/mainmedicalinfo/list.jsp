...
<div class="easyui-layout" fit="true" id="cc" style="width:100%;">
	...
	<div data-options="region:'center'">
		 <grid:grid id="mainMedicalInfoGridId" url="${adminPath}/medicalinfo/mainmedicalinfo/ajaxList">
			...
			<grid:button groupname="opt" title="预测" url="${adminPath}/medicalinfo/mainmedicalinfo/{id}/predict" 
			function="rowDialogDetailRefresh" outclass="btn-info" innerclass="fa-globe"/>
