...
<body class="white-bg"  formid="schBasisMaterialForm" style="margin: 0 30px;">
    <input type="hidden" name="ddd" id="ddd" readonly="readonly" >
    <form:form id="schBasisMaterialForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="specification" htmlEscape="false" class="form-control"  datatype="*"    />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
		        ...
		        <tr>
					...
					<td class="width-35">
					    <form:gridselect gridId="fMeasurementUnitGridId" genField="true" title="选择单位"  path="schMeasurementUnitId" datatype="*"
