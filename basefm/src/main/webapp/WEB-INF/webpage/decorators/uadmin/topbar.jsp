    ...
    <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;" class="navbar navbar-default navbar-static-top">
       <div class="navbar-header">
           ...
           <a id="logo" href="${adminPath}" class="navbar-brand">
	           ...
	           <span style="display: none" class="logo-text-icon"><spring:message code="sys.project.name_english"/></span>
           </a>
       </div>
           ...
           <ul class="nav navbar navbar-top-links navbar-right mbn">
               ...
               <li class="dropdown topbar-user">
                   ...
                   <ul class="dropdown-menu dropdown-user pull-right">
                       ...
                       <li><a href="#"  data-toggle="modal" data-target="#change-password"><i class="fa fa-key"></i>修改密码</a></li>  
                       <li class="divider"></li>
                      ...
                      <!--  <li>
                       ...
                       <li>
                           ...
                           <select id="list-header" class="form-control">
                               <option value="header-static">不锁定</option>
                               <option value="header-fixed">锁定顶部</option>
                           </select>
                       </li>
                  ...
                  <form  id="changePasswordForm"  method="post" action="${adminPath}/sys/user/${fns:getUser().id}/changePassword" class="form"> 
	                <div class="form-group">
	                    <div class="input-icon"><i class="fa fa-key"></i>
	                          <input type="password" value="" name="password"  class="form-control" datatype="*6-16" nullmsg="请设置密码！" placeholder="输入原密码" errormsg="密码范围在6~16位之间！" />
		             		  <label class="Validform_checktip"></label>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <div class="input-icon"><i class="fa fa-key"></i>
	                        <input type="password" value="" name="userpassword2" class="form-control" datatype="*" recheck="password" nullmsg="请再输入一次密码！" placeholder="请再输入一次密码！" errormsg="您两次输入的账号密码不一致！" />
		             		<label class="Validform_checktip"></label>
	                    </div>
	                </div>
		          </form>
