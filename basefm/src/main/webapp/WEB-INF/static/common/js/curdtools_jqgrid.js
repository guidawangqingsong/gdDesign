 ...
 * @param addurl//目标页面地址
 */
function createRefresh(title,url,gridid,width,height) {
	openDialogRefresh(title,url,gridid,width,height);
}
...
//打开对话框(添加修改) 增加添加完成之后自动刷新页面 by zhoukai 2017-11-24
function openDialogRefresh(title,url,gridId,width,height){
